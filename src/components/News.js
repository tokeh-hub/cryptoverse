...
const News = ({simplified}) => {
  ...
  const {data: cryptoNewsList, isFetching} = useGetCryptoNewsQuery({newsCategory: newsCategory,count: simplified ? 6 : 12})
                  ...
                  <Card hoverable className='news-card'>
                      <a href={news.url} target='_blank' rel='noreferrer'>
                        <div className='news-image-container'>
                            ...
                            <img style={{maxHeight:'100px',maxWidth: '100px'}} src={news?.image?.thumbnail.contentUrl || demoUrl} alt={news.name}/>
                            </div>
                            <p>
                        ...
                        <div className='provider-container'>
                          <div>
                            <Avatar src={news.provider[0]?.image?.thumbnail?.contentUrl || demoUrl}/>
