...
const HomePage = () => {
  ...
  return (
    ...
    <div className='home-heading-container'>
         ...
         <Typography.Title level={3} className='show-more'><Link to='/cryptocurrencies' simplified={false}>Show More</Link></Typography.Title>
    </div>
    <Cryptocurrencies simplified hide/>
